...
public class NearbyPlace extends FragmentActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nearbyplace);
...
//        locationTv.setText(Constants.AREA);
        ...
        if(status!=ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            btnFind.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sb.append("&key=AIzaSyCuhdrbMD-UuVfvB-LE6MR326UBN41Z50g");
