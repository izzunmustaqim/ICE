...
public class Medicines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllWidgets();
        sQLiteHelper = new SQLiteHelper(Medicines.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            int type = data.getIntExtra(Constants.TYPE,2);
    ...
    private void getAllWidgets() {
        btnAddNewRecord = (Button) findViewById(R.id.btnAddNewRecordM);
    ...
    private void onAddRecord() {
        Intent intent = new Intent(Medicines.this, TableManipulationMedicines.class);
    ...
    private void displayAllRecords() {
        ...
        ArrayList<MedicinesModel> contacts = sQLiteHelper.getAllRecordsM();
                        ...
                        builder.setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0) {
                                    ...
                                    AlertDialog.Builder deleteDialogOk = new AlertDialog.Builder(Medicines.this);
                                    deleteDialogOk.setTitle("Delete Medicines?");
